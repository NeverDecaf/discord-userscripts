...
waitForLoad(10000, () => {
	var uploadFunc = wm.find(m => m.default && m.default.length == 6 && m.default.toString().includes('anyFileTooLarge'))
    ...
    return function () {
        ...
        if (arguments[0].length == 1) {
            if (arguments[0][0].size > wm.findByUniqueProperties(['anyFileTooLarge']).maxFileSize()) {
