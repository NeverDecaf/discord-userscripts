    ...
    function main() {
        ...
        class Filters {
            ...
            static byStrings(...strings) {
                return (module) => {
                    if (
                        !module?.toString ||
                        typeof module?.toString !== "function"
                    )
            ...
            static byStoreName(name) {
                return (module) => {
                    return (
                        module?._dispatchToken && module?.getName?.() === name
                    );
                };
            }
        ...
        class WebpackModules {
            ...
            static findAll(filter) {
                return this.getModule(filter, { first: false });
            }
            ...
            static modules = new Proxy(
                ...
                {
                    ownKeys() {
                        return Object.keys(WebpackModules.require.m);
                    },
                    ...
                    set() {
                        throw new Error(
                            "[WebpackModules~modules] Setting modules is not allowed.",
                        );
                    },
                },
            );
            ...
            static getBulk(...queries) {
                ...
                for (let i = 0; i < indices.length; i++) {
                    ...
                    for (let q = 0; q < queries.length; q++) {
                        ...
                        if (!first && !returnedModules[q])
                            returnedModules[q] = []; // If they want multiple and we haven't setup the subarry, do it now
            ...
            static getMangled(filter, mangled, options = {}) {
                ...
                for (const searchKey in module) {
                    if (
                        !Object.prototype.hasOwnProperty.call(module, searchKey)
                    )
                        continue;
            ...
            static getAllBySource(match) {
                return this.getModule(Filters.bySource(match), {
                    first: false,
                });
            }
                    ...
                    const listener = function (exports, module, id) {
                        ...
                        if (
                            ...
                            for (const key in exports) {
                                ...
                                const wrappedExport = exports[key];
                                if (!wrappedExport) continue;
                                if (wrappedFilter(wrappedExport, module, id))
                                    foundModule = wrappedExport;
                            }
                        } else {
                            if (
                                exports.Z &&
                                wrappedFilter(exports.Z, module, id)
                            )
                                foundModule = defaultExport
                                    ? exports.Z
                                    : exports;
                            if (
                                exports.ZP &&
                                wrappedFilter(exports.ZP, module, id)
                            )
                                foundModule = defaultExport
                                    ? exports.ZP
                                    : exports;
                            if (
                                exports.__esModule &&
                                exports.default &&
                                wrappedFilter(exports.default, module, id)
                            )
                                foundModule = defaultExport
                                    ? exports.default
                                    : exports;
                            if (wrappedFilter(exports, module, id))
                                foundModule = exports;
                        }
            ...
            static get require() {
                ...
                if (typeof window[this.chunkName] !== "undefined") {
                    window[this.chunkName].push([
                        [id],
                        {},
                        (__internal_require__) => {
                            if ("b" in __internal_require__) {
                                __discord_webpack_require__ =
                                    __internal_require__;
                            }
                        },
                    ]);
