...
(function () {
    ...
    class WebpackModules {
        ...
        static getModule(filter, options = {}) {
            ...
            for (let i = 0; i < indices.length; i++) {
                ...
                if (
                    ...
                    let foundModule = null;
                    if (exports.Z && wrappedFilter(exports.Z, module, index))
                        foundModule = defaultExport ? exports.Z : exports;
                    if (exports.ZP && wrappedFilter(exports.ZP, module, index))
            ...
            return new Promise((resolve) => {
                ...
                const listener = function (exports, module, id) {
                    ...
                    if (
                        ...
                        if (exports.Z && wrappedFilter(exports.Z, module, id))
                            foundModule = defaultExport ? exports.Z : exports;
                        if (exports.ZP && wrappedFilter(exports.ZP, module, id))
                            foundModule = defaultExport ? exports.ZP : exports;
                        if (
                            exports.__esModule &&
                            exports.default &&
        ...
        static get chunkName() {
            return "webpackChunkdiscord_userscript";
        }
